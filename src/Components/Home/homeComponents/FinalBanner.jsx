    ...
    return (
        <Box>
            ...
            <Box display={{ base: 'none', md: 'none', lg: 'block' }} className="fiximg" style={{ marginTop: "7px" }} height={{ base: '130px', md: '220px', lg: '300px' }} width={{ base: '100%', md: '100%', lg: '100%' }}>
                ...
                >
                    <div>
                        <Img height={{ base: '130px', md: '220px', lg: '280px' }} src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/f82e744004955661.jpg?q=50" alt="" />
                    </div>
                    <div>
                        <Img height={{ base: '130px', md: '220px', lg: '280px' }} src="https://rukminim2.flixcart.com/fk-p-flap/1600/270/image/ded637b326a88ad7.jpg?q=50" alt="" />
                    </div>
                    <div>
                        <Img height={{ base: '130px', md: '220px', lg: '280px' }} src="https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/1e31c9d65e3b4592.jpg?q=50" alt="" />
                    </div>
                    <div>
                        <Img height={{ base: '130px', md: '220px', lg: '280px' }} src="https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/61775218f4487fe8.jpg?q=50" alt="" />
                    </div>
                    <div>
                        <Img height={{ base: '130px', md: '220px', lg: '280px' }} src="https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/cc633426b89ad841.png?q=50" alt="" />
                    </div>
